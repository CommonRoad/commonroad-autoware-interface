...
def get_absolute_path_from_package(
    ...
    :param relative_path: path to the config file; may be an absolute path or a path relative **to the packages src
    directory**. (e.g. `autoware/src/universe/autoware.universe/planning/tum_commonroad_planning/cr2autoware` for the
    cr2autoware node)
    :param package_name: the package name to which paths are relative to :return: absolute path to the config file
    """
