...
class TestDriveLogger:
    ...
    def log_data(self, scenario_time, behavior_time, trajectory_time, total_cycle_time, current_velocity, velocity_profile, smoothed_velocity, current_position, curvilinear_path):
        self.data.append({
