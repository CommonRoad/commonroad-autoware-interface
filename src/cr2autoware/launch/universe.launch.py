...
def launch_setup(context, *args, **kwargs):
    ...
    autoware_launch_file    = LaunchConfiguration("autoware_launch_file",    default="autoware.launch.xml")
    autoware_launch_package = LaunchConfiguration("autoware_launch_package", default="cr2autoware")
